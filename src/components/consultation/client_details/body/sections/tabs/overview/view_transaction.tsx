...
const ViewTransaction = () => {
  ...
  return (
    <Flex direction="column">
      {/* close */}
      <Flex justifyContent="between" alignItems="center" paddingX={3}>
        <DrawerCloseButton />
      </Flex>
        ...
        >
          ...
          <Flex gap="30%" padding="10px" paddingBottom="0px">
            <Flex direction="column" gap="20px">
              ...
              <FirstBoxText
                title="Wire instructions / purpose of payment"
                text="Payment from Proc to INC"
              />
            </Flex>
            <Flex direction="column" gap="20px">
              <FirstBoxText
              ...
              <FirstBoxText
                title="Address"
                text="Ubungo, Sinza,, Dar es salaam 16102"
              />
            </Flex>
          </Flex>
        </Box>
